...
Theorem nil_app : forall X:Type, forall l:list X,
  app [] l = l.
Proof.
  intros A l. simpl. reflexivity. Qed.
...
Proof.
  intros X l1 l2 v. induction l1 as [|n l'].
  Case "l1 = nil".
    simpl. reflexivity.
  Case "l1 = cons".
...
Theorem pair_fst_snd : forall (X Y : Type) (p : X * Y),
  p = (fst p, snd p).
Proof.
  intros X Y p.
...
Proof.
  intros X Y Z f p.
  unfold prod_curry. unfold prod_uncurry. destruct p. simpl.
  reflexivity. Qed.
(** [] *)
...
Theorem snoc_map : forall (X Y : Type) (f : X -> Y) (x : X) (l : list X),
...
Proof.
  ...
  unfold override. rewrite H1. rewrite H2. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  Case "l = cons".
    simpl. unfold fold_length. simpl. fold (fold_length l). rewrite IHl. reflexivity.
  Qed.
(** [] *)
...
Theorem fold_map_eq_map : forall {X Y : Type} (f : X -> Y) (l : list X),
...
Proof.
  ...
  Case "l = cons".
    unfold fold_map. simpl. fold (fold_map f l). rewrite IHl. reflexivity.
  Qed.
(** [] *)
