...
Proof.
  intros. induction H.
  apply g_0. apply g_plus3.
  apply g_0. apply g_plus5.
...
Proof.
  ...
  rewrite plus_0_r in IHgorgeous. rewrite plus_assoc.
  apply g_plus3. apply g_plus3. apply IHgorgeous.
  rewrite plus_0_r. rewrite helper_g_times2. rewrite plus_assoc.
  apply g_plus5. apply g_plus5. rewrite plus_0_r in IHgorgeous. apply IHgorgeous.
Qed.
(** [] *)
